...
export const createContrato = async (req, res, next) => {
  try {
    const newContrato = await createContratoService(req.body);
...
export const updateContrato = async (req, res, next) => {
  try {
    ...
    const contratoAtualizado = await updateContratoService(
      id,
      req.body
    );
...
export const deleteContrato = async (req, res, next) => {
  try {
    const contrato = await deleteContratoService(req.params.id);
