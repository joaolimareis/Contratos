...
export const getAllLocatariosByIDService = async (id) => {
  const result = await pool.query("SELECT * FROM WHERE id = $1", [id])
  return result.rows[0];
}

export const createLocatariosService = async (dadosCreate) => {
...
export const updateLocatariosService = async (id, dadosAtualizados) => {
