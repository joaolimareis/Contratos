...
export const getAlllocadorByIDService = async (id) => {
  const result = await pool.query("SELECT * FROM WHERE id = $1", [id])
  return result.rows[0];
}

export const createlocadorService = async (dadosCreate) => {
...
export const updatelocadorService = async (id, dadosAtualizados) => {
