...
export const getUsusariosByIdService = async (id) => {
...
export const updateUsuariosService = async (email, senha, status, id) => {
...
export default {createUsuariosService, getAllUsuariosService, getUsusariosByIdService,updateUsuariosService, deleteUsuariosService}
