...
export const createImovelService =  async (dadosCreate) => {
...
export const getAllImovelByIdService = async (id) => {
  const result = await pool.query("SELECT * FROM imoveis WHERE id=$1", [id])
  return result.rows[0]
  
}

export const updateImovelService = async (id, dadosAtulizados) => {
